...
// <Description>
//    NUnit tests for the PBKDF2 class. Implements the PBKDF2 test vectors given here: http://tools.ietf.org/html/draft-josefsson-pbkdf2-test-vectors-00.     
...
namespace PasswordHash.Test
{
    ...
    {
        [Theory, Trait("Note", "The last test instance takes quite long.")]
        ...
        [InlineData("password", "salt", 16777216, 20, "ee fe 3d 61 cd 4d a4 e4 e9 94 5b 3d 6b a2 15 8c 26 34 e9 84")] // takes long (almost 1 min)
